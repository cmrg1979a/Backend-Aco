...
export const validateDocumentEnterpriseNuevo = async (req: Request, res: Response) => {
  const data = req.query;

  await pool.query("SELECT *from function_validar_tipo_documento_y_documento_nuevo_empresa($1,$2, $3);", [
    data.id_branch,
    data.id_document,
    data.document,
  ],
...
export const validateDocumentEnterpriseEditar = async (req: Request, res: Response) => {
  const data = req.query;

  await pool.query("SELECT *from function_validar_tipo_documento_y_documento_editar_empresa($1,$2, $3, $4);", [
    data.id,
    data.id_branch,
    data.id_document,
    data.document,
