...
export const getListModality = async (req: Request, res: Response) => {
  ...
  await pool.query(
    "SELECT *from function_modality_listar($1,$2, $3, $4, $5);",
    [
      data.id_branch,
...
export const insertModality = async (req: Request, res: Response) => {
  ...
  await pool.query(
    "SELECT *from function_modality_insertar($1,$2, $3, $4, $5);",
    [
      dataObj.id_branch,
      dataObj.name,
      dataObj.code,
...
export const readModality = async (req: Request, res: Response) => {
  ...
  await pool.query(
    "SELECT *from function_modality_ver($1);",
    [data.id],
    (err, response, fields) => {
      if (!err) {
        let rows = response.rows;
...
export const updateModality = async (req: Request, res: Response) => {
  ...
  await pool.query(
    "SELECT *from function_modality_actualizar($1,$2, $3, $4);",
