...
router.get("/validar_nuevo_acronimo_sex/", TokenValidation, validateAcronymInTableSexNuevo);
router.get("/validar_editar_acronimo_sex/", TokenValidation, validateAcronymInTableSexEditar);
