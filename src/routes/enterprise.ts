...
router.get("/validar__nuevo_documento_enterprise/", TokenValidation, validateDocumentEnterpriseNuevo);
router.get("/validar_editar_documento_enterprise/", TokenValidation, validateDocumentEnterpriseEditar);
